    ...
    <nav className="bg-primaryBlue text-[#ffffff] p-3 flex justify-between items-center font-semibold text-lg shadow-lg">
     ...
     isSidebarOpen ? 'translate-x-0' : 'translate-x-full '}`} >
      ...
      <div className="flex items-center gap-2 ">
        ...
        <a className="hidden md:block border-2 border-accentYellow px-3 py-1 rounded-lg bg-accentYellow hover:cursor-pointer hover:bg-accentYellowDark text-[#ffffff]">
          Buy Ticket
        </a>
        <button onClick={toggleSidebar}>
