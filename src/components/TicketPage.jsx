...
useEffect(() => {
  ...
  return (
    <section>
      ...
      >
        <h1  className="text-6xl font-bold">Registration</h1>
        <p className="font-semibold">Step-Up Summit 2025</p>
        <p className="text-lg mb-10 max-w-2xl mx-auto mt-16">
          {" "}
          Be part of a transformative gathering where ideas meet opportunity.
          Whether you are a student, young professional, entrepreneur, or
          forward thinker, the Step-Up Summit gives you the platform to rise
          above limits and take the next step in your growth.
        </p>
      </div>
    </section>
  );
