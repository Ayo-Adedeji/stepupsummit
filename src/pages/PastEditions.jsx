...
import e1d from "../assets/img2.JPG";
import e1e from "../assets/img5.JPG";
import e1f from "../assets/img7.jpg";
import e2a from "../assets/1.jpg";
import e2b from "../assets/2.jpg";
import e2c from "../assets/3.jpg";
import e2d from "../assets/11.jpeg";
import e2e from "../assets/5.jpg";
import e2f from "../assets/6.jpg";
import e2g from "../assets/7.jpg";
import e2h from "../assets/8.jpg";
import e2i from "../assets/9.jpg";
import e2j from "../assets/10.jpg";

const gallery1 = [e1a, e1b, e1c, e1d];
const gallery2 = [e2a, e2b, e2c, e2d];
const marquee1 = [e1a, e1b, e1c, e1d, e1e, e1f];
const marquee2 = [e2a, e2b, e2c, e2d, e2e, e2f, e2g, e2h, e2i, e2j];
    ...
    <div className="bg-white">
        ...
        <div className="mx-auto max-w-6xl px-5 lg:px-8">
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            <ScrollReveal>
              ...
              <h3 className="mt-3 font-heading text-3xl font-bold text-brand-blue">The one that started it all</h3>
              ...
              <div className="mt-6 flex gap-8">
                <div><b className="block font-heading text-2xl text-brand-blue">700+</b><span className="text-xs uppercase text-gray-500">Attendees</span></div>
                <div><b className="block font-heading text-2xl text-brand-blue">8</b><span className="text-xs uppercase text-gray-500">Thought leaders</span></div>
                <div><b className="block font-heading text-2xl text-brand-blue">Alumni Hall, UI</b><span className="text-xs uppercase text-gray-500">Venue</span></div>
              </div>
            </ScrollReveal>
        ...
        <div className="mx-auto max-w-6xl px-5 lg:px-8">
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            ...
            <ScrollReveal>
              ...
              <h3 className="mt-3 font-heading text-3xl font-bold text-brand-blue">Bigger. Bolder. Smarter.</h3>
              ...
              <div className="mt-6 flex gap-8">
                <div><b className="block font-heading text-2xl text-brand-blue">400+</b><span className="text-xs uppercase text-gray-500">Students impacted</span></div>
                <div><b className="block font-heading text-2xl text-brand-blue">7</b><span className="text-xs uppercase text-gray-500">Featured speakers</span></div>
                <div><b className="block font-heading text-2xl text-brand-blue">ICC, UI</b><span className="text-xs uppercase text-gray-500">Venue</span></div>
              </div>
            </ScrollReveal>
          </div>
        </div>
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-3xl px-5">
          <ScrollReveal>
            <blockquote className="border-l-4 border-brand-gold pl-6 font-heading text-lg font-medium italic leading-relaxed text-brand-blue">
      ...
      <section className="bg-brand-off-white py-20">
        <div className="mx-auto max-w-6xl px-5 lg:px-8">
          <div className="text-center">
            ...
            <h2 className="mt-3 font-heading text-3xl font-bold text-brand-blue sm:text-4xl">Moments from the movement</h2>
          </div>

          {/* MARQUEE 1 , Edition 1.0 */}
          <div className="mt-12">
            ...
            <div className="mt-4 overflow-hidden">
              <div className="flex w-max marquee-track">
                {[...marquee1, ...marquee1].map((g, i) => (
                  <img
                    key={i}
                    src={g}
                    alt="Step-Up Summit 1.0"
                    className="mx-3 h-[200px] w-auto rounded-xl object-cover sm:h-[280px]"
                  />
                ))}
              </div>
            </div>
          ...
          <div className="mt-12">
            ...
            <div className="mt-4 overflow-hidden">
              <div className="flex w-max marquee-track-reverse">
                {[...marquee2, ...marquee2].map((g, i) => (
                  <img
                    key={i}
                    src={g}
                    alt="Step-Up Summit 2.0"
                    className="mx-3 h-[200px] w-auto rounded-xl object-cover sm:h-[280px]"
                  />
                ))}
              </div>
      ...
      <section className="bg-gradient-to-br from-brand-blue-mid to-brand-blue py-20 text-center text-white">
        <div className="mx-auto max-w-3xl px-5">
          ...
          <Link
            to="/register"
            className="mt-8 inline-block rounded-full bg-brand-gold px-10 py-4 font-heading text-lg font-semibold text-brand-blue transition hover:bg-brand-gold-light"
          >
            Register for 3.0
          </Link>
        </div>
